...
public class Sample2App {
    ...
    private static final Logger log = LoggerFactory.getLogger(Sample2App.class);

    private final Environment env;

    public Sample2App(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Sample2App.class);
